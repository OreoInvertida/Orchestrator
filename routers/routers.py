...
from services.orchestrator_service import process_registration, sign_document, get_operators
...
async def auth_doc(payload: dict = Depends(verify_token)):
    return await get_operators()
